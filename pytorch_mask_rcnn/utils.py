...
def save_ckpt(model, optimizer, epochs, chptPath, **kwargs):
    checkpoint = {}
    ...
    prefix, ext = os.path.splitext(chptPath)
    chptPath = "{}-{}{}".format(prefix, epochs, ext)
    torch.save(checkpoint, chptPath)
