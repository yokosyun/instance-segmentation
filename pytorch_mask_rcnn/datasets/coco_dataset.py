...
class COCODataset(GeneralizedDataset):
    def __init__(self, dataDir, split, train=False):
        ...
        ann_file = os.path.join(dataDir, "annotations/instances_{}.json".format(split))
        ...
        checked_id_file = os.path.join(dataDir, "checked_{}.txt".format(split))
        if train:
    ...
    def get_image(self, img_id):
        ...
        image = Image.open(os.path.join(self.dataDir, "{}".format(self.split), img_info["file_name"]))
